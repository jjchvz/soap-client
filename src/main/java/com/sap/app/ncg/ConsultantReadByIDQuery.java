...
/**
 * <p>Clase Java para ConsultantReadByIDQuery complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultantReadByIDQuery"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ConsultantReadByIDQuery", propOrder = {
    "sapuuid",
    "id"
})
public class ConsultantReadByIDQuery {
